...
const AddPet = () => {
    ...
    useEffect(() => {
        if (formData.idEspecie) {
            const fetchRacas = async () => {
                ...
                try {
                    const data = await RacaAPI.buscarRacasPorEspecie<Raca[]>(
                        parseInt(formData.idEspecie),
                        token
                    );
                    if (Array.isArray(data)) {
                        setRacas(data);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const dataNascimento =
            anoNascimento && mesNascimento
                ? `${anoNascimento}-${mesNascimento}-01`
                : null;
        ...
        try {
            await PetAPI.cadastrarPet(submissionData, token);
            toast({
                title: "Sucesso!",
            ...
            // O `apiFetch` já mostra um toast de erro genérico
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => {
                                                setFormData({...formData, idEspecie: value, idRaca: ""});
                                            }}
                                        >
                                            <SelectTrigger>
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                setFormData({...formData, idRaca: value})
                                            }
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(value) =>
                                                        ...
                                                        setFormData({...formData, mesNascimento: value})
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(value) =>
                                                        ...
                                                        setFormData({...formData, anoNascimento: value})
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => {
                                                setFormData({...formData, idPorte: value});
                                            }}
                                        >
                                            <SelectTrigger>
